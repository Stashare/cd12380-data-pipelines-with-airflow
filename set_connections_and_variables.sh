...
#
airflow connections add aws_credentials --conn-uri 'aws://AKIA5DCMMRRXCWQ3KPQA:YP5NnEmBxcL9spDg7mHkSXzT1otdQ0%2FEIUvUx4zD@'
# TO-DO: run the follwing command and observe the JSON output: 
...
# TO-DO: Update the following command with the URI and un-comment it:
#
airflow connections add redshift --conn-uri 'redshift://awsuser:Ires12%23%24@default-workgroup.899955854446.us-east-1.redshift-serverless.amazonaws.com:5439/dev'
#
